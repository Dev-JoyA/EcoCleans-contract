...
contract EcoCleans is User, Admin, Product {
    ...
    function approveRider(uint256 _riderId) public {
        ...
        emit RiderApproved(_riderId, riderId[_riderId].name, riderId[_riderId].phoneNumber, riderId[_riderId].vehicleNumber, riderId[_riderId].vehicleImage, riderId[_riderId].country, riderId[_riderId].capacity, riderId[_riderId].vehicleType);
    }
